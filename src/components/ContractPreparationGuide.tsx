...
export default function ContractPreparationGuide({
  ...
  const filteredSteps = steps.filter(
    step => step.contractTypes.includes(contractType) || contractType === "all"
  );
        ...
        <div className="space-y-3 md:space-y-4">
          {filteredSteps.length === 0 ? (
            <div className="text-center py-8">
              <FileWarning className="w-10 h-10 md:w-12 md:h-12 text-amber-500 mx-auto mb-4" />
            ...
            filteredSteps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center mr-2 md:mr-3 flex-shrink-0">
                  ...
                  {isExpanded && (
                    <div className="p-3 md:p-4 border-t">
                      ...
                      <div className="mb-4">
                        ...
                        <ul className="space-y-1 pl-4 md:pl-6 list-disc text-xs md:text-sm text-gray-600">
